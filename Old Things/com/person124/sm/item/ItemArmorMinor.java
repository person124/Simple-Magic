...
public class ItemArmorMinor extends ItemArmor{
	...
	public ItemArmorMinor(int id, EnumArmorMaterial material, int par3, int par4, String name, CreativeTabs tab) {
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		if (slot == 0 || slot == 2) return "simplemagic:textures/models/armor/EleMinor_1.png";
		if (slot == 3 || slot == 4) return "simplemagic:textures/models/armor/EleMinor_2.png";

		return "simplemagic:textures/models/armor/EleMinor_1.png";
	}
	...
	public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack is) {
		...
		//event damage for fragor effect
	}
