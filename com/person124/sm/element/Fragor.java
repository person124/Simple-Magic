...
public class Fragor {
	...
	public static final ToolMaterial FRAGOR_SWORD_MATERIAL = EnumHelper.addToolMaterial("FRAGORSWORD", 0, 45, 0.0F, 0F, 0);
	...
	public static final Item FRAGOR_SWORD = new ItemFragorSword(FRAGOR_SWORD_MATERIAL, "fragorsword");
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ItemStack(FRAGOR_DUST, 4), new Object[] { "!@!", "@!@", "!@!", '!', new ItemStack(SimpleMagic.MAGIC_DUST, 1), '@', new ItemStack(Items.gunpowder) });
